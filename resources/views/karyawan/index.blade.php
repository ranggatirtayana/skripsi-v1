...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <h4 align="center">SISTEM RUMAH SAKIT</h4>
      <div class="container-fluid">
        ...
        <div>
            ...
            <a href="{{ route('karyawan.create') }}"><button>Tambah Data</button></a>
        </div>
          </div>
        ...
        <thead>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ $vk->divisi }}</td>
                    <td>
                        <a href="{{ route('karyawan.edit', $vk->id) }}"><button>Edit</button></a>
                        <a href="{{ route('karyawan.destroy', $vk->id) }}" onclick="return confirm('Hapus data dengan nama {{ $vk->nama_lengkap }}')"><button>Hapus</button></a>
                    </td>
                </tr>
                @empty
                <tr>
