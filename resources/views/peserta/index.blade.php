      ...
      <div class="container-fluid">
        ...
        <table class="table table-bordered">
                ...
                @forelse($peserta as $vk)
                    ...
                    <td>{{ $vk->alamat }}</td>
                    <td>
                        <a href="{{ route('peserta.edit', $vk->id) }}"><button>Edit</button></a>
                        <a href="{{ route('peserta.destroy', $vk->id) }}" onclick="return confirm('Hapus data dengan nama {{ $vk->nama_lengkap }}')"><button>Hapus</button></a>
                    </td>
                    </tr>@empty
                    <tr>
